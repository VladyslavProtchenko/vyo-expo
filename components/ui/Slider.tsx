...
export default function Slider({
  ...
  // Calculate position for value indicator (accounting for thumb size)
  const thumbSize = 50;
  ...
  const handleValueChangeStart = () => {
    // Increase size when interaction starts
  ...
  return (
    <View style={styles.container}>
      <View style={styles.sliderWrapper} onLayout={handleLayout}>
        ...
        {/* Custom thumb with value and animation */}
