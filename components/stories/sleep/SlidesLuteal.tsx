  ...
  return (
    <View style={s1.container}>
      <View style={s1.content}>
        <Text style={s1.title}>{t('stories.luteal.slide1.title')}</Text>

        <Text style={s1.body}>
          {t('stories.luteal.slide1.para1_pre')}
          <Text style={s1.highlight}>{t('stories.luteal.slide1.para1_hl1')}</Text>
          {t('stories.luteal.slide1.para1_mid1')}
          <Text style={s1.highlight}>{t('stories.luteal.slide1.para1_hl2')}</Text>
          {t('stories.luteal.slide1.para1_mid2')}
          <Text style={s1.highlight}>{t('stories.luteal.slide1.para1_hl3')}</Text>
          {t('stories.luteal.slide1.para1_post')}
        </Text>

        <Text style={s1.body}>{t('stories.luteal.slide1.para2')}</Text>
      </View>
    ...
    <View style={s3.container}>
      <View style={s3.content}>
        <View style={s3.header}>
          ...
          <Text style={s3.subtitle}>{t('stories.luteal.slide2.subtitle')}</Text>
        </View>
