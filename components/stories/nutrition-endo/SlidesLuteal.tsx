...
function Slide4({ showButton = false }: { showButton?: boolean }) {
  const { t } = useTranslation();
  return (
    <View style={[s4.container, showButton && s4.containerWithButton]}>
      ...
      {showButton && <ButtonGradient title={t('nutrition_stories_endo.luteal.slide4.button')} />}
    </View>
  );
}
...
export const LUTEAL_STORIES_ENDO: Story[] = createLutealStoriesEndo();
