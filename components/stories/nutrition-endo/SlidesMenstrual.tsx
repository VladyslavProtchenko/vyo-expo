  ...
  return (
    <View style={s5.container}>
      <View style={s5.content}>
        ...
        <View style={s5.row}>
          <Image source={{ uri: `${STORAGE_URL}/content/phases/food-3-1.webp` }} style={s5.photo} contentFit="cover" />
  ...
  return (
    <View style={s6.container}>
      <View style={s6.content}>
        ...
        <View style={s6.row}>
          <Image source={{ uri: `${STORAGE_URL}/content/phases/food-5.webp` }} style={s6.photo} contentFit="cover" />
...
export const createMenstrualStoriesEndo = (navigate: () => void): Story[] => [
  { id: 1, render: () => <Slide1 /> },
  { id: 2, render: () => <Slide2 /> },
  { id: 3, render: () => <Slide3 /> },
  { id: 4, render: () => <Slide4 /> },
...
export const MENSTRUAL_STORIES_ENDO: Story[] = createMenstrualStoriesEndo(() => {});
