  ...
  return (
    <View style={styles.container}> 
      <TouchableOpacity onPress={() => navigation.goBack()} style={{flexDirection: 'row', alignItems: 'center', marginBottom: 4}}>
        ...
        <Text style={{fontFamily: 'Poppins', fontSize: 16, fontWeight: '600', marginLeft: 12, flex: 1}}>Deleted items</Text>
      </TouchableOpacity>
      <Text style={{marginTop:24}} >Restore earlier deleted products and they appear in your daily recommendation sets.</Text>
        ...
        <View style={{flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', marginTop:24}}>
          {allProducts.map((product) => (
            <View key={product} style={{width: 100, alignItems: 'center', position: 'relative'}}>
              <TouchableOpacity style={{position: 'absolute', top: 4, right: 4, zIndex: 1, borderRadius: 100, padding: 6, paddingHorizontal: 10, backgroundColor: 'rgba(34, 171, 139, 0.8)'}}>
