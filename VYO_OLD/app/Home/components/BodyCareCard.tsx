...
export default function BodyCareCard({
  ...
  return (
    <View style={{ flexDirection: 'row' }}>
      ...
      />
      <TouchableOpacity 
        onPress={() => navigation.navigate('BodyCare' as never) }
        style={{ padding: 16, borderRadius: 24, flexDirection: 'row', backgroundColor: '#F7F7F7', flex: 1}}
      >
        <View style={{ flex: 1, marginRight: 12 }}>
          <Text style={{fontSize: 16, fontFamily: "ArchivoBlack-Regular", marginBottom: 8}}>Body Care</Text>
          <View style={{ flexDirection: 'row', flexWrap: 'wrap'}}>
            {['Pelvic floor release', 'Pilates', 'Stretching'].map((item) =>(
        ...
        <View style={{ width: 80, height: 80, borderRadius:12, overflow: 'hidden'}}>
          <Image 
            source={require('../../../assets/images/mission-2.webp')} 
