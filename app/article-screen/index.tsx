    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.green}>
          ...
          <Text style={styles.greenP}>
            Women's health is key to overall well-being. Regular check-ups, a balanced diet, and exercise help manage unique challenges like menstruation, pregnancy, and menopause.
          </Text>
        </View>
        ...
        {Array.from({ length: 4 }).map((_, index) => (
          <Text style={[typography.p, { marginBottom: 8 }]} key={index}>
            {index + 1}. Source name{' '}
            <Text style={styles.referenceLink} onPress={() => openLink('https://www.google.com')}>
              Link
            </Text>
          </Text>
        ))}
