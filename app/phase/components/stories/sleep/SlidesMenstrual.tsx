  ...
  return (
    <View style={s1.container}>
      <View style={s1.content}>
        <Text style={s1.title}>{t('stories.menstrual.slide1.title')}</Text>

        <Text style={s1.body}>
          {t('stories.menstrual.slide1.para1_pre')}
          <Text style={s1.highlight}>{t('stories.menstrual.slide1.para1_hl')}</Text>
          {'.'}
        </Text>

        <Text style={s1.body}>{t('stories.menstrual.slide1.para2')}</Text>

        <Text style={s1.body}>
          {t('stories.menstrual.slide1.para3_pre')}
          <Text style={s1.highlight}>{t('stories.menstrual.slide1.para3_hl1')}</Text>
          {t('stories.menstrual.slide1.para3_mid')}
          <Text style={s1.highlight}>{t('stories.menstrual.slide1.para3_hl2')}</Text>
        </Text>
      </View>
  ...
  return (
    <View style={s2.container}>
      <View style={s2.content}>
        <Text style={s2.body}>{t('stories.menstrual.slide2.para1')}</Text>

        <Text style={s2.body}>
          {t('stories.menstrual.slide2.para2_pre')}
          <Text style={s2.highlight}>{t('stories.menstrual.slide2.para2_hl')}</Text>
          {t('stories.menstrual.slide2.para2_post')}
        </Text>
      </View>
...
const PRACTICES: Practice[] = [
  { labelKey: 'stories.menstrual.slide3.practice1', image: require('@/assets/images/phases/stress-m-3-1.webp'), labelSide: 'left' },
  { labelKey: 'stories.menstrual.slide3.practice2', image: require('@/assets/images/phases/stress-m-3-2.webp'), labelSide: 'right' },
  { labelKey: 'stories.menstrual.slide3.practice3', image: require('@/assets/images/phases/stress-m-3-3.webp'), labelSide: 'left' },
];
    ...
    <View style={s3.container}>
      <View style={s3.content}>
        <View style={s3.header}>
          <Text style={s3.title}>{t('stories.menstrual.slide3.title')}</Text>
          <Text style={s3.subtitle}>{t('stories.menstrual.slide3.subtitle')}</Text>
        </View>
      ...
      <ButtonGradient title={t('stories.menstrual.slide3.button')} />
    </View>
  );
}
