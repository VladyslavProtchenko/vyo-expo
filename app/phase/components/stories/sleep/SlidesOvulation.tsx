  ...
  return (
    <View style={s1.container}>
      <View style={s1.content}>
        <Text style={s1.title}>{t('stories.ovulation.slide1.title')}</Text>

        <Text style={s1.body}>
          {t('stories.ovulation.slide1.para1_pre')}
          <Text style={s1.highlight}>{t('stories.ovulation.slide1.para1_hl1')}</Text>
          {t('stories.ovulation.slide1.para1_mid')}
          <Text style={s1.highlight}>{t('stories.ovulation.slide1.para1_hl2')}</Text>
          {t('stories.ovulation.slide1.para1_post')}
        </Text>

        <Text style={s1.body}>
          {t('stories.ovulation.slide1.para2_pre')}
          <Text style={s1.highlight}>{t('stories.ovulation.slide1.para2_hl')}</Text>
          {t('stories.ovulation.slide1.para2_post')}
        </Text>
      </View>
  ...
  return (
    <View style={s2.container}>
      <View style={s2.content}>
        <Text style={s2.body}>
          {t('stories.ovulation.slide2.para1_pre')}
          <Text style={s2.highlight}>{t('stories.ovulation.slide2.para1_hl')}</Text>
          {t('stories.ovulation.slide2.para1_post')}
        </Text>

        <Text style={s2.body}>{t('stories.ovulation.slide2.para2')}</Text>
      </View>
    ...
    <View style={s3.container}>
      <View style={s3.content}>
        <View style={s3.header}>
          ...
          <Text style={s3.subtitle}>{t('stories.ovulation.slide3.subtitle')}</Text>
        </View>
