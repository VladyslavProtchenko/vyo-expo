  ...
  return (
    <View style={s1.container}>
      ...
      <View style={s1.content}>
        <Text style={s1.title}>{t('exercise_stories.luteal.slide1.title')}</Text>

        <Text style={s1.body}>
          {t('exercise_stories.luteal.slide1.para1_pre')}
          <Text style={s1.highlight}>{t('exercise_stories.luteal.slide1.para1_hl')}</Text>
          {t('exercise_stories.luteal.slide1.para1_post')}
        </Text>

        <Text style={s1.body}>
          {t('exercise_stories.luteal.slide1.para2_pre')}
          <Text style={s1.highlight}>{t('exercise_stories.luteal.slide1.para2_hl')}</Text>
          {t('exercise_stories.luteal.slide1.para2_post')}
        </Text>

        <Text style={s1.body}>
          {t('exercise_stories.luteal.slide1.para3_pre')}
          <Text style={s1.highlight}>{t('exercise_stories.luteal.slide1.para3_hl')}</Text>
          {t('exercise_stories.luteal.slide1.para3_post')}
        </Text>
      </View>
...
const PRACTICES: Practice[] = [
  { labelKey: 'exercise_stories.luteal.slide2.practice1', image: require('@/assets/images/phases/sport-3-4.webp'), labelSide: 'left' },
  { labelKey: 'exercise_stories.luteal.slide2.practice2', image: require('@/assets/images/phases/sport-f-2.webp'), labelSide: 'right' },
  { labelKey: 'exercise_stories.luteal.slide2.practice3', image: require('@/assets/images/phases/sport-3-3.webp'), labelSide: 'left' },
  { labelKey: 'exercise_stories.luteal.slide2.practice4', image: require('@/assets/images/phases/sport-f-4.webp'), labelSide: 'right' },
];
  ...
  return (
    <View style={s2.container}>
      <View style={s2.content}>
        <Text style={s2.subtitle}>{t('exercise_stories.luteal.slide2.subtitle')}</Text>
        <View style={s2.list}>
          {PRACTICES.map((item) => (
