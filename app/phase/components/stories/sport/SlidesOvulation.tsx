  ...
  return (
    <View style={s1.container}>
      ...
      <View style={s1.content}>
        ...
        <Text style={s1.body}>
          {t('exercise_stories.ovulation.slide1.para1_pre')}
          <Text style={s1.highlight}>{t('exercise_stories.ovulation.slide1.para1_hl1')}</Text>
          {t('exercise_stories.ovulation.slide1.para1_mid1')}
          <Text style={s1.highlight}>{t('exercise_stories.ovulation.slide1.para1_hl2')}</Text>
          {t('exercise_stories.ovulation.slide1.para1_mid2')}
          <Text style={s1.highlight}>{t('exercise_stories.ovulation.slide1.para1_hl3')}</Text>
          {t('exercise_stories.ovulation.slide1.para1_post')}
        </Text>

        <Text style={s1.body}>{t('exercise_stories.ovulation.slide1.para2')}</Text>
      </View>
